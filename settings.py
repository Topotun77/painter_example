...
ICON_NEW = './icon/new.png'
ICON_BRASH = './icon/brash.png'
ICON_ERASER = './icon/eraser.png'
ICON_PIPETTE = './icon/pipette.png'
...
# ICON_BRASH = path.join(sys._MEIPASS, './icon/brash.png')
# ICON_ERASER = path.join(sys._MEIPASS, './icon/eraser.png')
# ICON_PIPETTE = path.join(sys._MEIPASS, './icon/pipette.png')
